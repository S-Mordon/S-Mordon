...
Olá! Me chamo **Fernando Henrique**, sou estudante de **Análise e Desenvolvimento de Sistemas** na **SPTech School** e atuo como **Desenvolvedor Full Stack** em constante evolução.

Tenho interesse tanto em **frontend** quanto em **backend**, buscando desenvolver aplicações completas, bem estruturadas e com foco em boas práticas, organização de código e experiência do usuário. Ao longo da minha jornada acadêmica e prática, venho trabalhando com projetos que envolvem APIs, sistemas web e interfaces modernas.
